...
%**************************************************************************
% File: Aebeam.m
%   Creates the element transformation matrix and rotation matrix for the
%   transformation between local- and global coordinates for a spatial beam
%   element.
%
%   Created for the course 41207: Thin-Walled Beam Structures at DTU by Jan
%   Høgsberg
% Syntax:
%   Ae = Aebeam(Xe,X3e)
% Input:
